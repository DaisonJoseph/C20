...
//	$user = $db->user; if (!isset($_SESSION['Uid'])) { header('Location:login.php'); } 
	$results->sort(array('languagecomplexityscore' => 1));
	$lowcount=0;
	$medcount=0;
	$highcount=0;
	foreach ($results as $result)
	{
			$score = 1 - $result['languagecomplexityscore'];
			if ($score < 0.3)
			{
				$lowcount++;
			}
  ...
  <div class="main-content" id="panel">
    ...
    <nav class="navbar navbar-top navbar-expand navbar-dark bg-primary border-bottom">
      <div class="container-fluid">
		...
		<div class="col-xl-5">
             <div class="card-body" style="font-size:22px;color:#edeffc;margin-left: -37px;">Technical Feasibility By Applications</div>
            </div>
              ...
              <div class="card" >
                <div class="card-body" >
					<div class="row">
					  ...
					  <div class="col-lg-3 col-sm-3 col-xs-12 text-center"> <small>Highly Feasible Applications</small>
						<h2><?php echo $highcount ?></h2>
						<div id="sparklinedash2"></div>
					  </div>
					  <div class="col-lg-3 col-sm-3 col-xs-12 text-center"> <small>Medium Feasible Applications</small>
						<h2><?php echo $medcount ?></h2>
						<div id="sparklinedash3"></div>
					  </div>
					  <div class="col-lg-3 col-sm-3 col-xs-12 text-center"> <small>Low Feasible Applications</small>
        ...
        <div class="col-xl-12">
          <div class="card">
            <div class="card-header bg-transparent">
              <div class="row">
                <div class="col">
                  <h5 class="h3">Application Technical Feasibility</h5>
                </div>
              </div>
            </div>
            <div class="card-body">
				<div class="panel-group" id="accordion">
										...
										<!--<div class="collapse">
											<h4 style="color:#3F51B5;margin-left:30px;">ORSA</h4>
												<p><div  id="portability-chart-default" style="height:690px;width:1060px;"></div></p>
										</div>-->
									</div>				
          ...
          <div class="card">
            <div class="card-header border-0">
              <div class="row align-items-center">
                <div class="col">
                  <h3 class="mb-0">Technical Feasibility Table</h3>
				  <a href="download.php?input=feasibility" class="blue-cascade pull-right" style="display:inline"> Download CSV
              ...
              <table class="table align-items-center table-flush">
                <thead class="thead-light">
                  <tr>
                    ...
                    <th scope="col">Technical Feasibility Score</th>
                  </tr>
                </thead>
                <tbody>
               <?php
								...
								{
										$score = 1 - $result['languagecomplexityscore'];
										echo "<tr><td>" . $result['appname'] . "</td><td>" . $score . "</td></tr>";
								}
								?>
                </tbody>
              </table>
...
<script>
		...
		var chart = AmCharts.makeChart("top_x_div", {
		  ...
		  "colorRanges": [{
			...
			"color": "#990707",
			"variation": 0,
			"valueProperty": "Technical Feasibility Index",
			"colorProperty": "color"
		  }, {
			"start": 0.31,
			"end": 0.505,
		  ...
		  "dataProvider": [		
			<?php
				...
				foreach ($results as $result){					
						...
						echo '{"Application": "' . $result['appname'] . '",
									  "Technical Feasibility Index":' . $score . ',
		   ...
		   "valueAxes": [{
			...
			"gridAlpha": 0.2,
			"dashLength": 0,
			"title": "Technical Feasibility Index",
			"position": "top"
		  }],
		  "gridAboveGraphs": true,
		  "startDuration": 1,
		  "graphs": [{
			//"balloonText": "[[Application]]:<br/>Application Technology Complexity:[[apptechnologycomplexity]]<br/>Application Complexity Level:[[appcomplexitylevel]]<br/>Application Size:[[appsizevalue]]",
			"labelText": "[[Technical Feasibility Index]]",
			"fillAlphas": 1,
			  "balloon": {
			...
			"lineAlpha":0.2,
			"type": "column",
			"valueField": "Technical Feasibility Index",
			"colorField": "color"
		  }],
		  "chartCursor": {
...
//			"tickLength": 2,
		  ...
		  "export": {
			"enabled": true,
			"fileName": "technical_feasibility"
		  }
	...
	chart.addListener("rollOverGraphItem", function(event) {
	  ...
	  b.innerHTML = "Application " + ": <b>" + event.item.dataContext["Application"] + "</b><br>" 
					+"Technical Feasibility Index " + ": <b>" + event.item.dataContext["Technical Feasibility Index"] + "</b><br>"
					+ "Application Technology Complexity" + ": <b>" + event.item.dataContext["apptechnologycomplexity"]+ "</b><br>" 
					+ "Application Complexity Level" + ": <b>" + event.item.dataContext["appcomplexitylevel"] + "</b><br>" 
					+ "Application Size" + ": <b>" + event.item.dataContext["appsizevalue"]+ "</b>";
